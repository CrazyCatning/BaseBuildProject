...
int32_t SaveClient::save_data(const std::string& name, const std::string& password, const int32_t player1_id, const int32_t player2_id)
{
  send_save_data(name, password, player1_id, player2_id);
  return recv_save_data();
}

void SaveClient::send_save_data(const std::string& name, const std::string& password, const int32_t player1_id, const int32_t player2_id)
{
  int32_t cseqid = 0;
...
void SaveProcessor::process_save_data(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot, void* callContext)
{
  ...
  try {
    result.success = iface_->save_data(args.name, args.password, args.player1_id, args.player2_id);
...
int32_t SaveConcurrentClient::save_data(const std::string& name, const std::string& password, const int32_t player1_id, const int32_t player2_id)
{
  int32_t seqid = send_save_data(name, password, player1_id, player2_id);
  return recv_save_data(seqid);
}

int32_t SaveConcurrentClient::send_save_data(const std::string& name, const std::string& password, const int32_t player1_id, const int32_t player2_id)
{
